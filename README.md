...
## Geplante Features
- Verbesserte Stromsimulation (BFS/DFS über PowerLines)
- Häuser werden visuell aktiv (z.B. gelb bei Strom)
- Energieverluste über Transformatoren
- Geldsystem & Kosten
- Upgrades (effizientere Netze)
- Bessere UI (Panels, Buttons)
- Sprites & Animationen
- Sound
